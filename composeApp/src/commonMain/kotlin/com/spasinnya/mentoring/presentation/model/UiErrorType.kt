...
sealed class UiErrorType {
    ...
    /** 401 on sign-in - the email/password pair is wrong */
    data object InvalidCredentials : UiErrorType()

    /** 401 on an authorized call - the session is gone and the user has to sign in again */
