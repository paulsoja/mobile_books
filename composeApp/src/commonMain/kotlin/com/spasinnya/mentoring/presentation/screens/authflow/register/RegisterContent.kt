...
import com.spasinnya.mentoring.generated.resources.auth_already_have_account
import com.spasinnya.mentoring.generated.resources.auth_create_account
import com.spasinnya.mentoring.generated.resources.auth_email
import com.spasinnya.mentoring.generated.resources.auth_login
import com.spasinnya.mentoring.generated.resources.auth_or
import com.spasinnya.mentoring.generated.resources.auth_password
import com.spasinnya.mentoring.generated.resources.auth_register
import com.spasinnya.mentoring.generated.resources.auth_register_hello
...
fun RegisterContent(
    ...
    Column(
        ...
        EmailInput(
            ...
            onValueChange = { onEvent(RegisterContract.Event.EmailChanged(it)) }
        )
        ...
        PasswordInput(
            ...
            onToggleVisibility = { onEvent(RegisterContract.Event.PasswordVisibilityToggled(it)) },
            onValueChange = { onEvent(RegisterContract.Event.PasswordChanged(it))  }
        )
